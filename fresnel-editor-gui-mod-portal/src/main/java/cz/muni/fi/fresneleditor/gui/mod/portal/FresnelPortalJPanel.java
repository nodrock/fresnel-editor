            ...
            .add(fresnelPortalVisualizationJPanelLayout.createSequentialGroup()
                ...
                .add(fresnelPortalVisualizationJPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    ...
                    .add(fresnelPortalVisualizationJPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(fresnelPortalVisualizationJPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(selectTransformationComboBox, 0, 527, Short.MAX_VALUE)
                            .add(selectServiceComboBox, 0, 527, Short.MAX_VALUE)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, fresnelPortalVisualizationJPanelLayout.createSequentialGroup()
                                .add(4, 4, 4)
                                .add(outputFileTextField, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 414, Short.MAX_VALUE)
                                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                                .add(outputFileBtn))
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, fresnelPortalVisualizationJPanelLayout.createSequentialGroup()
                                .add(3, 3, 3)
                                .add(visualizeBtn, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 523, Short.MAX_VALUE)
                                .add(1, 1, 1)))))
                .addContainerGap())
        );
