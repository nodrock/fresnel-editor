...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  version="1.0">
    ...
    <xsl:param name="documentName" select="Fresnel rendered page"/>
    ...
    <xsl:template match="/">
        <html>
            <head>
                ...
                <link rel="stylesheet" type="text/css" href="http://jfresnel.gforge.inria.fr/WebContent/ResultsReporting/fresnel2html.css"/>
            </head>
            <body>
                <!-- Extract styling information to CSS stylesheet -->
                <table bgcolor="#c3d9ff" border="0" cellpadding="0" cellspacing="20" width="50%">
                    <tr>
                        <td>
