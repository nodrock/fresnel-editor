...
public class FresnelEditorConstants {
    ...
    public static final String DEFAULT_XSL_SVG_TEMPLATE_URL = "src/main/resources/xsl/fresnel-to-svg-full.xsl";
    public static final String DEFAULT_SVG_CSS_STYLESHEET_URL = PATH_FRESNEL_EDITOR_RESOURCES + "css/visualization-svg-default-style.css";
