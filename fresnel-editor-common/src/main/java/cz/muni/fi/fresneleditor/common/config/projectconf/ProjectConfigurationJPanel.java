...
public class ProjectConfigurationJPanel extends javax.swing.JPanel implements
	...
	public ProjectConfigurationJPanel(ProjectConfiguration configuration,
		...
		if (configuration != null) {
			...
			dataRepoCombo
					.setSelectedItem(configuration.getDataRepositoryName());
		}
	...
	private void updateRepositoriesCombos() {
		...
		List<String> dataReposNames = ContextHolder.getInstance()
				.getDataRepositoryNames();
		ExtendedDefaultComboBM<String> dModel = new ExtendedDefaultComboBM<String>(
				dataReposNames);
		dataRepoCombo.setModel(dModel);
	}
	...
	private void initComponents() {
		...
		org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application
				...
				.getContext().getResourceMap(ProjectConfigurationJPanel.class);
		projectRepositoriesPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(resourceMap
						.getString("projectRepositoriesPanel.border.title"))); // NOI18N
		projectRepositoriesPanel.setName("projectRepositoriesPanel"); // NOI18N

		dataRepoCombo.setName("dataRepoCombo"); // NOI18N
		...
		dataRepoLbl.setText(resourceMap.getString("dataRepoLbl.text")); // NOI18N
		dataRepoLbl.setName("dataRepoLbl"); // NOI18N

		javax.swing.GroupLayout projectRepositoriesPanelLayout = new javax.swing.GroupLayout(
				projectRepositoriesPanel);
		projectRepositoriesPanel.setLayout(projectRepositoriesPanelLayout);
		projectRepositoriesPanelLayout
				.setHorizontalGroup(projectRepositoriesPanelLayout
						.createParallelGroup(
		...
		projectRepositoriesPanelLayout
				.setVerticalGroup(projectRepositoriesPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								projectRepositoriesPanelLayout
		...
		basicProjectInfoPanel.setBorder(javax.swing.BorderFactory
				.createTitledBorder(resourceMap
						.getString("basicProjectInfoPanel.border.title"))); // NOI18N
		...
		projectDescriptionTextArea.setFont(resourceMap
				.getFont("projectDescriptionTextArea.font")); // NOI18N
		...
		projectDescriptionScrollPane
				.setViewportView(projectDescriptionTextArea);

		projectDescriptionLbl.setText(resourceMap
				.getString("projectDescriptionLbl.text")); // NOI18N
		...
		projectNameText.setDisabledTextColor(resourceMap
				.getColor("projectNameText.disabledTextColor")); // NOI18N
		...
		projectFileText.setDisabledTextColor(resourceMap
				.getColor("projectFileText.disabledTextColor")); // NOI18N
		...
		browseProjectFileBtn.setText(resourceMap
				.getString("browseProjectFileBtn.text")); // NOI18N
		...
		javax.swing.GroupLayout basicProjectInfoPanelLayout = new javax.swing.GroupLayout(
				basicProjectInfoPanel);
		basicProjectInfoPanel.setLayout(basicProjectInfoPanelLayout);
		basicProjectInfoPanelLayout
				.setHorizontalGroup(basicProjectInfoPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								basicProjectInfoPanelLayout
										...
										.addContainerGap()));
		basicProjectInfoPanelLayout
				.setVerticalGroup(basicProjectInfoPanelLayout
						.createParallelGroup(
								javax.swing.GroupLayout.Alignment.LEADING)
						.addGroup(
								basicProjectInfoPanelLayout
		...
		layout.setHorizontalGroup(layout
				...
				.addComponent(projectRepositoriesPanel,
						javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addComponent(basicProjectInfoPanel,
						javax.swing.GroupLayout.Alignment.TRAILING,
						javax.swing.GroupLayout.DEFAULT_SIZE,
						javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE));
	...
	private javax.swing.JComboBox dataRepoCombo;
	private javax.swing.JLabel dataRepoLbl;
	...
	boolean saveProjectConfiguration() {
		...
		configuration.setFresnelRepositoryName((String) fresnelRepoCombo
				.getSelectedItem());
		configuration.setDataRepositoryName((String) dataRepoCombo
				.getSelectedItem());
	...
	private boolean validateConfiguration() {
		...
		if (dataRepoCombo.getSelectedIndex() == -1) {
			return false;
		}
		return true;
	}
	...
	public void repositoriesChanged(RepositoriesChangedEvent evt) {
		...
		Object dataRepo = dataRepoCombo.getSelectedItem();

		updateRepositoriesCombos();

		fresnelRepoCombo.setSelectedItem(fresnelRepo);
		dataRepoCombo.setSelectedItem(dataRepo);
	}
